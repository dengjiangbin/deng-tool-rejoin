...
function extractClientSnapshotProof(body) {
  ...
  return {
    ...
    leaderstatsReady: boolFlag(body?.leaderstatsReady) || boolFlag(body?.hasLeaderstatsSnapshot),
    fishScanReady: boolFlag(body?.fishScanReady) || boolFlag(body?.hasFishSnapshot),
    stoneScanReady: boolFlag(body?.stoneScanReady) || boolFlag(body?.hasStoneSnapshot),
    scanCompleted: boolFlag(body?.scanCompleted) || boolFlag(body?.snapshotComplete),
