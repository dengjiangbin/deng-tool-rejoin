#!/usr/bin/env node
/**
 * BLOCKER10F: post-push guard — raw GitHub tracker.lua must be valid Lua source.
 */
const https = require('https');
const { execFileSync } = require('child_process');
const path = require('path');

const BUILD_MARKER = process.argv[2] || 'BLOCKER10F_SAFE_MINIMAL_NO_FREEZE_COMPILE_GATE_2026_06_03';
...
(async () => {
  ...
  if (!src.includes('TRACKER_BOOT_BEGIN BLOCKER10F')) errors.push('TRACKER_BOOT_BEGIN BLOCKER10F missing on raw GitHub');
