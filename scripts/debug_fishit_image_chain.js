...
async function main() {
  ...
  for (const name of names) {
    ...
    const row = {
      ...
      leaderboard_source_used: ['fish_catalog_seen', 'fishThumbnails', 'catch_detail', 'forgotten_catalog', 'forgotten_emoji'].includes(source.source),
      leaderboard_source_path: 'C:\\Users\\Administrator\\Desktop\\DENG Fish It\\utils\\fishImageResolver.js',
      channel_source_id: source.source === 'fish_catalog_seen' ? '1481530183545520159 or caught-source catalog' : null,
