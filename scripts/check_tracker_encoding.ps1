...
if ($content -match 'TRACKER_BUILD BLOCKER10') { Write-Host "PASS  TRACKER_BUILD BLOCKER10 marker found" } else { $errors += "FAIL  TRACKER_BUILD BLOCKER10 marker missing" }
if ($content -match 'BLOCKER10_ITEM_NAME_RESOLUTION_2026_06_03') { Write-Host "PASS  BLOCKER10 build id found" } else { $errors += "FAIL  BLOCKER10 build id missing" }
