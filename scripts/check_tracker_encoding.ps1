...
if ($content -match 'TRACKER_BUILD BLOCKER10B') { Write-Host "PASS  TRACKER_BUILD BLOCKER10B marker found" } else { $errors += "FAIL  TRACKER_BUILD BLOCKER10B marker missing" }
if ($content -match 'BLOCKER10B_RESTORE_FISH_AND_SAFE_ITEM_UPGRADE_2026_06_03') { Write-Host "PASS  BLOCKER10B build id found" } else { $errors += "FAIL  BLOCKER10B build id missing" }
