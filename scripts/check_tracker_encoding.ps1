...
if ($content -match 'TRACKER_BUILD BLOCKER9') { Write-Host "PASS  TRACKER_BUILD BLOCKER9 marker found" } else { $errors += "FAIL  TRACKER_BUILD BLOCKER9 marker missing" }
if ($content -match 'BLOCKER9_CATALOG_RESOLVE_AND_NIL_FIX_2026_06_03') { Write-Host "PASS  BLOCKER9 build id found" } else { $errors += "FAIL  BLOCKER9 build id missing" }
...
if ($content -match 'CATALOG_LOOKUP_HIT') { Write-Host "PASS  CATALOG_LOOKUP_HIT log found" } else { $errors += "FAIL  CATALOG_LOOKUP_HIT missing" }
if ($content -match 'CATALOG_SOURCE_FOUND') { Write-Host "PASS  CATALOG_SOURCE_FOUND log found" } else { $errors += "FAIL  CATALOG_SOURCE_FOUND missing" }
