...
async function main() {
  ...
  if (BLOCKER10ZQ_CLEAN_DIST_REPO_LIVE_CACHE_REQUEST_PM2_HEALTH_MARKER
    !== 'BLOCKER10ZQ_CLEAN_DIST_REPO_LIVE_CACHE_REQUEST_PM2_HEALTH_2026_06_10') {
    errors.push('BLOCKER10ZQ marker mismatch in fishitTrackerBuild.js');
  }
  ...
  if (!body.includes(BLOCKER10ZQ_CLEAN_DIST_REPO_LIVE_CACHE_REQUEST_PM2_HEALTH_MARKER)) {
    errors.push('/inventory missing BLOCKER10ZQ marker');
  }
